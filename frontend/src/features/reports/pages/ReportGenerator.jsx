...
import { reportService, taskService, groupService } from '../../../shared/services/api';
import {
  Download,
  FileText,
  LayoutTemplate,
...
import uthLogo from '../../../shared/assets/uth_logo.jpg';
          ...
          <div style={{ position: 'sticky', top: '2rem' }}>
            ...
            <div className="document-preview print-area" id="printable-doc">
              ...
              <div style={{ textAlign: 'center', marginBottom: '50px', paddingBottom: '30px', borderBottom: '2px solid #111827' }}>
                <img src={uthLogo} alt="UTH Logo" style={{ width: '120px', height: 'auto', marginBottom: '15px', display: 'block', margin: '0 auto' }} />
                <p style={{ fontSize: '1rem', fontWeight: '700' }}>ĐẠI HỌC GIAO THÔNG VẬN TẢI THÀNH PHỐ HỒ CHÍ MINH</p>
              ...
              <div style={{ marginTop: '60px', textAlign: 'right' }}>
                ...
                <p style={{ fontWeight: 'bold' }}>BỘ MÔN LẬP TRÌNH JAVA</p>
              </div>
            </div>
          </div>
        </div>
