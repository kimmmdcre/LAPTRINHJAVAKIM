...
import { Plus, Users, Search, MoreVertical, ExternalLink, UserCheck, Trash2, FolderOpen, X, Settings } from 'lucide-react';
...
const AdminGroups = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      // Fetch separately to be resilient if one endpoint fails
      try {
